...
const PlayerCard = React.memo(function PlayerCard({ player, onClick }: PlayerCardProps) {
  ...
  // Motion values for smooth 3D tilt without triggering React renders
  ...
  return (
    <motion.div
      ...
      className="relative h-[380px] w-full cursor-pointer select-none overflow-visible"
      style={{
        perspective: 1000,
        rotateX,
        rotateY,
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            "w-full flex justify-center transition-all duration-300 absolute bottom-0",
